...
//                 <h2 className="text-xl font-semibold text-gray-800 mb-4">Check Symptoms</h2>
//                 <p className="text-gray-600 mb-6">How would you like to check your symptoms?</p>
...
//                 <button
//                     onClick={onClose}
//                     className="w-full py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors"
//                 >
//                     Cancel
//                 </button>
//             </div>
