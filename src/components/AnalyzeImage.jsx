...
//                     <p className="text-gray-600">AI-powered wound assessment</p>
//                 </div>
...
//                         </div>
//                         <p className="text-gray-800 text-lg">{result.size || "Not specified"}</p>
//                     </div>
...
//                         </div>
//                         <p className="text-gray-800 text-lg">{result.color || "Not specified"}</p>
//                     </div>

//                     <div className="bg-white rounded-lg p-4 border border-gray-100 shadow-xs">
//                         <div className="flex items-center mb-2">
//                             <span className="text-yellow-600 text-xl mr-2">⚠️</span>
//                             <h3 className="font-semibold text-gray-700">Infection Risk</h3>
//                         </div>
//                         <p className="text-gray-800 text-lg">{result.infectionRisk || "Not specified"}</p>
//                     </div>
...
//                             <h3 className="font-semibold text-gray-700">Care Recommendations</h3>
//                         </div>
//                         <p className="text-gray-800">{result.careRecommendations}</p>
//                     </div>
//                 )}
...
//                 <h1 className="text-2xl font-bold text-gray-800 mb-2">Wound Analysis</h1>
//                 <p className="text-gray-600 mb-6">Upload an image of a wound for AI-powered analysis</p>
...
//                                 accept="image/*"
//                             />
//                             <div className="border-2 border-dashed border-gray-300 rounded-lg py-4 px-6 text-center hover:border-blue-400 transition-colors">
