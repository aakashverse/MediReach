        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 bg-gray-900 rounded-lg p-4">
            <div className="flex flex-col space-y-3">
              ...
              <button 
                onClick={() => openAuthModal("signup")}
                className="text-left hover:text-indigo-300 transition-colors duration-200 py-2"
              >
                SignUp
              </button>
              ...
              <a href="/profile" className="hover:text-green-300 transition-colors duration-200 py-2">
                My Report
              </a>
            </div>
          </div>
